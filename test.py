...
if __name__ == "__main__":
    ...
    results_dir = r'./result/tangka/mask60/'
    ...
    TransRef = torch.load("/root/autodl-fs/lhc/TransRef/TR/TransRef-main/checkpoints/DH/latest_Trans.pth")

    model.model.load_state_dict(TransRef['net'], strict=False)

    input_mask_paths = glob('{:s}/*'.format("/root/autodl-fs/lhc/TransRef/test_mask256/mask50-60/"))
    input_mask_paths.sort()
    de_paths = glob('{:s}/*'.format("/root/autodl-fs/lhc/fanhua/tangka/images/"))
    de_paths.sort()
    ref_paths = glob('{:s}/*'.format("/root/autodl-fs/lhc/test/blackreference/"))
    ref_paths.sort()
